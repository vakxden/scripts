...
BUILD_DATE=$(date)
node index.js --platform=ios --workspace=/Users/jenkins/git/product --prefix=$BRANCH- --epubs=/Users/jenkins/irls-reader-current-epubs --buildnumber="users-mac-mini build number 1" --builddate="$BUILD_DATE"
