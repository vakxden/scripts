### This job should take such variables as NIGHTLY_REMOTE_BUILD, READER_BRANCH_NAME, READER_COMMIT_HASH, ID, FACET, NIGHTLY_MACMINI_EPUBS, NIGHTLY_ARTIFACTS_DIR, ENVIRONMENT 
